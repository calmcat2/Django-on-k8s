...
This is the Kubernetes version of the Django restaurant system developed based on the image created in the repository [here](https://github.com/calmcat2/littlelemon/tree/v1).
